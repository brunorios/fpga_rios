...
ExecStep xelab -m64 --debug typical --relax -L xil_defaultlib -L secureip --snapshot tb_debounce_behav --prj T:/fpga_rios/aula5/debounce/debounce.sim/sim_1/behav/tb_debounce.prj   xil_defaultlib.tb_debounce
