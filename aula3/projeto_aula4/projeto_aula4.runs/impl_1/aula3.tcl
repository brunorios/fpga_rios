...
set rc [catch {
  ...
  add_files -quiet T:/fpga_rios/aula3/projeto_aula4/projeto_aula4.runs/synth_1/aula3.dcp
  read_xdc T:/fpga_rios/aula3/projeto_aula4/projeto_aula4.srcs/constrs_1/imports/Problemas/io_basico.xdc
  link_design -top aula3 -part xc7a100tcsg324-1
...
set rc [catch {
  ...
  catch {update_ip_catalog -quiet -current_ip_cache t:/fpga_rios/aula3/projeto_aula4/projeto_aula4.cache}
  opt_design 
...
set rc [catch {
  ...
  write_bitstream -force aula3.bit 
